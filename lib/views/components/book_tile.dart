...
class _BookTileState extends State<BookTile> {
  ...
  void deleteOperation() {
    //TODO: operation de supression d'un auteur
  }
  ...
  void clickOnModify() {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            ModifyBookScreen(book: widget.book, bookAuthor: author),
      ),
    );
  }
          ...
          children: [
                    ...
                    IconButton(
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(AppSnackBar(
                            snackContent: "Livre supprimé avec succès"));
                      },
                      icon: Icon(
            ...
            Query(
              options: QueryOptions(
                document: gql(AuthorEndPoint.getAuthorByIdQuery),
                ...
                return Text.rich(
                  TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(
                          text: " par ${author.firstname} ${author.name}."),
                    ],
                  ),
                );
              },
